...
$sshdConfigPath = join-path $env:ProgramData\Procesure\ssh "sshd_config"
...
Get-ChildItem $env:ProgramData\Procesure\ssh\ssh_host_*_key -ErrorAction SilentlyContinue | % {
